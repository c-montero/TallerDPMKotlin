    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       /* val bindingNav = NavHeaderMainBinding.inflate(layoutInflater)
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_basicos, R.id.nav_recyclerview, R.id.nav_usuarios, R.id.nav_cocteles, R.id.nav_lectorqr, R.id.nav_login, R.id.nav_mapas, R.id.nav_camara,R.id.nav_realtime
            ), drawerLayout
        )
